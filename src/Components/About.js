      ...
      <Row>
        <Col>
          <p className="text-justify">
            Throughout 2020 I have been actively developing my computer science
            knowledge and web development skills. I am completing The Developer
            Academy’s Software Developer Bootcamp and have completed HarvardX
            “CS50 Introduction to Computer Science” course. This has given me
            some great experience using Javascript, React, Redux, C/C++, SQL,
            Flask, Jinja, HTML and CSS. Some of my portfolio projects
            demonstrate what I have done over this time.
          </p>
          <p className="text-justify">
          ...
          <ul>
            ...
            <li>
              Delivering production electric power steering components for Land
              Rover and Jaguar products,
            </li>
          ...
          <p className="text-justify">
            ...
            CAMRA. Specifically, I have a strong interest in historic pubs. When
            I get the chance I enjoy watching Wrexham AFC.
          </p>
        </Col>
      </Row>
      <br />
